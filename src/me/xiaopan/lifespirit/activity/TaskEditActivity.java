...
import me.xiaopan.lifespirit.task.item.AirplaneMode;
import me.xiaopan.lifespirit.task.item.Bluetooth;
import me.xiaopan.lifespirit.task.item.MobileNetwork;
import me.xiaopan.lifespirit.task.item.RingnoteMode;
import me.xiaopan.lifespirit.task.item.RingnoteMode.RingnoteModeEnum;
import me.xiaopan.lifespirit.task.item.ScreenBrightness;
import me.xiaopan.lifespirit.task.item.ScreenDormant;
import me.xiaopan.lifespirit.task.item.SendMessage;
import me.xiaopan.lifespirit.task.item.Volume;
import me.xiaopan.lifespirit.task.item.Wifi;
import me.xiaopan.lifespirit.widget.ApplicationAdapter;
import me.xiaopan.lifespirit.widget.TaskItemAdapter;
